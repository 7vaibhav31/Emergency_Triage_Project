...
import re
# Match everything from HTML_PAGE = """<!DOCTYPE html> to </html>"""
new_content = re.sub(r'HTML_PAGE = """<!DOCTYPE html>.*?</html>"""', 'HTML_PAGE = """' + new_html + '"""', content, flags=re.DOTALL)

with open("app.py", "w", encoding="utf-8") as f:
    f.write(new_content)
print("SUCCESS: app.py rewritten.")
